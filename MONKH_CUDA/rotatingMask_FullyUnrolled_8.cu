	...
	if (row < rows && col < cols) {
		...
		if ((bx < numberOfBlocksx - 1
			...
			if (tx < BLOCK_SIZE - 2 && ty < BLOCK_SIZE - 2) {
				...
				/* row 1 */
				dispersion += (input_img[ty + 0][tx + 0] - average)
						* (input_img[ty + 0][tx + 0] - average);

				dispersion += (input_img[ty + 0][tx + 1] - average)
						* (input_img[ty + 0][tx + 1] - average);

				dispersion += (input_img[ty + 0][tx + 2] - average)
						* (input_img[ty + 0][tx + 2] - average);

				/* row 2 */
				dispersion += (input_img[ty + 1][tx + 0] - average)
						* (input_img[ty + 1][tx + 0] - average);

				dispersion += (input_img[ty + 1][tx + 1] - average)
						* (input_img[ty + 1][tx + 1] - average);

				dispersion += (input_img[ty + 1][tx + 2] - average)
						* (input_img[ty + 1][tx + 2] - average);

				/* row 3 */
				dispersion += (input_img[ty + 2][tx + 0] - average)
						* (input_img[ty + 2][tx + 0] - average);

				dispersion += (input_img[ty + 2][tx + 1] - average)
						* (input_img[ty + 2][tx + 1] - average);

				dispersion += (input_img[ty + 2][tx + 2] - average)
						* (input_img[ty + 2][tx + 2] - average);
